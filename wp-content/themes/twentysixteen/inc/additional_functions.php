...
if ( ! function_exists( 'add_admin_css' ) ){
	...
	function add_admin_css() {
		echo '<link href="'.get_bloginfo('template_directory').'/admin/css/admin-style.css" rel="stylesheet" media="all"  />';
		echo '<script src="'.get_stylesheet_directory_uri().'/admin/js/tab-function.js"></script>';
