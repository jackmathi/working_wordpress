<?php
/*
Plugin Name: SEO Ultimate Plugin
Description: This all-in-one SEO plugin gives you control over meta titles & descriptions, open graph, auto-linking, rich-snippets, 404 monitoring and extra.
Version: 5.5
Author: KOK -india Solutions
Author URI: http://www.kok-india.in/
Text Domain: seo-ultimate Plugin
*/

/**
 * The main SEO Ultimate plugin file.
 * @package SeoUltimate Plugin
 * @version 7.6.5.9
 * SEO Ultimate Homepage
 */
