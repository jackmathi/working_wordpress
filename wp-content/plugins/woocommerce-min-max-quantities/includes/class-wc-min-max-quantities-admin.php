...
class WC_Min_Max_Quantities_Admin {
	...
	function write_panel() {
		...
		woocommerce_wp_text_input( array( 'id' => 'minimum_allowed_quantity', 'label' => __( 'Minimum quantity', 'woocommerce-min-max-quantities' ), 'description' => __( 'Enter a quantity to prevent the user buying this product if they have fewer than the allowed quantity in their cart', 'woocommerce-min-max-quantities' ), 'desc_tip' => true ) );

		woocommerce_wp_text_input( array( 'id' => 'maximum_allowed_quantity', 'label' => __( 'Maximum quantity', 'woocommerce-min-max-quantities' ), 'description' => __( 'Enter a quantity to prevent the user buying this product if they have more than the allowed quantity in their cart', 'woocommerce-min-max-quantities' ), 'desc_tip' => true ) );

		woocommerce_wp_text_input( array( 'id' => 'group_of_quantity', 'label' => __( 'Group of...', 'woocommerce-min-max-quantities' ), 'description' => __( 'Enter a quantity to only allow this product to be purchased in groups of X', 'woocommerce-min-max-quantities' ), 'desc_tip' => true ) );
    	...
    	$js = "
    		jQuery( document.body ).on( 'woocommerce-product-type-change', function( evt, value, variation ) {
				var allow_combination_field = jQuery( '.allow_combination_field' );
			...
			jQuery( '#woocommerce-product-data' ).on( 'woocommerce_variations_loaded', function() {
				var min_max_rules_options = jQuery( '.checkbox.min_max_rules' ).parents( '.woocommerce_variable_attributes' ).find( '.min_max_rules_options' );
			...
			jQuery( '.woocommerce_variations' ).on( 'change', '.checkbox.min_max_rules', function() {
				var min_max_rules_options = jQuery( this ).parents( '.woocommerce_variable_attributes' ).find( '.min_max_rules_options' );
