...
<!--        <a href="?page=dynamic-pricing-main-page&tab=licence" class="nav-tab  thickbox <?php //echo $active_tab == 'import_export' ? 'nav-tab-active' : ''; ?>"><?php //_e('Import/Export', 'eh-dynamic-pricing-discounts'); ?></a>  -->
        <a href="?page=dynamic-pricing-main-page&tab=licence" style="color:red;" class="nav-tab <?php echo $active_tab == 'licence' ? 'nav-tab-active' : ''; ?>"><?php _e('Go Premium', 'eh-dynamic-pricing-discounts'); ?></a>  <!-- removed thickbox for elementor compatibility -->
