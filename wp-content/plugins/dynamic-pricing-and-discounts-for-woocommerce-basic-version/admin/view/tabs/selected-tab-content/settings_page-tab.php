...
$dummy_settings['xa_product_add_on_option'] = 'enable';
...
if(!isset($xa_product_add_on_option)){
                        ...
                        <div class="panel-wrap product_data" style="min-height: 220px;">
                            <ul class="product_data_tabs wc-tabs">
                                ...
                                <li class="offers_tabel_option  " style="display: block;">
                                    <a href="#" onclick="select(this, '#offers_tabel_option')">
                                        <span>Offers Table <sup><font color="grey">Premium</sup></span>                                        
                                    </a>
                                </li>
                                <li class="bogo_rules_options  " style="display: block; margin-right: -5px">
                                    <a href="#" onclick="select(this, '#bogo_rules_options')">
                                        <span>BOGO options <sup><font color="grey">Premium</sup></span>
                                    </a>
                                </li>
                            ...
                            <div  class="panel woocommerce_options_panel" style="display: block;">
                                <div class="options_group" id="general_product_data" style="display: block;">
                                    ...
                                    ?>
                                    <p class="form-field  " >
                                    <label for="xa_product_add_on_option">Product Add On Support</label> 
                                    <span class="woocommerce-help-tip" data-tip="This option will add discount to the add on price for third party plugin WooCommerce Product Add-ons"></span>
                                        <select id="xa_product_add_on_option" name="xa_product_add_on_option" class="select short" style="" selected='<?php echo $xa_product_add_on_option ?>'>
                                            <option value='enable'  <?php echo(($xa_product_add_on_option == 'enable') ? 'selected' : ''); ?>>Yes</option>
                                            <option value='disable'  <?php echo(($xa_product_add_on_option == 'disable') ? 'selected' : ''); ?>>No</option>
                                        </select>
                                    </p>
                                    <?php
                                    }
                                ...
                                <div class="options_group" id="pricing_tabel_option" style="display: none;">
                                    ...
                                    <hr>
                                    <h4><span>The pricing table will only show offers from "Product Rules"</span></h4>
                                </div>
