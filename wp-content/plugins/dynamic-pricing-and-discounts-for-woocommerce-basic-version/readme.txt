...
Contributors: xadapter, niladrixadapter, adaptxy
Donate link:
...
= 3.3.9 =
 * WC compatibility tag updated.
= 3.3.8 =
 * Fixed "Pricing Table" issue in mobile view.

= 3.3.7 =
 * Woocommerce 2.6.14 compatibility.
 * Compatible with Third Party plugin- WooCommerce Product Add-On for WooCommerce 3.2.5.

= 3.3.6 =
 * Fixed PHP older version compatiblity

= 3.3.5 =
 * Fixed "Pricing Table" issue with linux file system

= 3.3.4 =
 * Fixed discounts not shown on category page
 * Supports discount on woocommerce product addons price
 * Fixed category rule on variations

= 3.3.0 =
 * Fixed Issue in product rules if category is selected

= 3.2.9 =
 * Fixed Pricing Table issue

= 3.2.6 =
 * Fixed Flat Discount issue in category rules

= 3.2.5 =
 * Bug fixed in category rules when minimum is 2 or more but shop page showing discount for 1
 * fixed fatal error in user roles
 ...
 * Added description for pricing table in settings page
 * Updated Link for Review in admin notice
 * Minimum ,Maximum and Adjustments fields will now accept decimal values

= 3.1.0 =
 * Fixed WPML Compatiblity issue

= 3.0.9 =
 * Fixed Flat discount not getting applied in product rules
 * Fixed Discount not getting applied if stock management is enabled

= 3.0.8 =
 * Fixed Category Rule Min /Max Issue

= 3.0.7 =
 * Fixed Error "Unknown Variable $cid"

= 3.0.6 =
 * Multi-Select category for category rules
 * Compatible to PHP Version 5.3 and above

= 3.0.5 =
 * Fixed Sale Badge compatibility issue with 3rd party themes
